        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContentLarge}>
            ...
            <View style={{ backgroundColor: '#ffffff', borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#cbd5e1', alignItems: 'center', marginBottom: 10 }}>
              <div style={{ width: '150px', height: '150px', borderRadius: '50%', background: totalModalityExecutions === 0 ? '#e2e8f0' : `#e2e8f0`, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', position: 'relative', marginBottom: '12px' }}>
                {totalModalityExecutions === 0 && (
